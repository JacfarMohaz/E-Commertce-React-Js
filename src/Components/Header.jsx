...
function Header() {
    ...
    return <div className="bg-primaryColor flex p-5 text-secondaryColor fixed w-full top-0 justify-between">
        ...
        <div style={{display: isOpen === true ? "flex" : " "}} className="sm:flex flex-col sm:flex-row mt-16 sm:mt-0 sm:space-x-10 space-x-0 space-y-5 sm:space-y-0 text-4xl hidden">
